...
class Disputes(BaseSDK):
    def list(
        ...
        *,
        organization_id: OptionalNullable[
            Union[
                models.DisputesListQueryParamOrganizationIDFilter,
                models.DisputesListQueryParamOrganizationIDFilterTypedDict,
            ]
        ] = UNSET,
        ...
        sorting: OptionalNullable[List[models.DisputeSortProperty]] = UNSET,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[models.DisputesListResponse]:
        r"""List Disputes
        ...
        **Scopes**: `disputes:read`
        ...
        request = models.DisputesListRequest(
        ...
        def next_func() -> Optional[models.DisputesListResponse]:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.DisputesListResponse(
                result=unmarshal_json_response(models.ListResourceDispute, http_res),
                next=next_func,
            )
    ...
    def get(
        ...
        **Scopes**: `disputes:read`
        ...
        request = models.DisputesGetRequest(
            id=id,
        )
