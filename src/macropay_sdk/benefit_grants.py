    ...
    def list(
        ...
        *,
        organization_id: OptionalNullable[
            Union[
                models.BenefitGrantsListQueryParamOrganizationIDFilter,
                models.BenefitGrantsListQueryParamOrganizationIDFilterTypedDict,
            ]
        ] = UNSET,
        ...
        sorting: OptionalNullable[List[models.BenefitGrantSortProperty]] = UNSET,
        ...
        **Scopes**: `benefits:read` `benefits:write`
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="benefit-grants:list",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.BenefitGrantsListResponse(
                result=unmarshal_json_response(
                    models.ListResourceBenefitGrant, http_res
                ),
                next=next_func,
            )
