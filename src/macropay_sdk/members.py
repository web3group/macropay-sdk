...
class Members(BaseSDK):
    def list_members(
    ...
    ) -> Optional[models.MembersListMembersResponse]:
        r"""List Members
        ...
        **Scopes**: `members:read` `members:write`
        ...
        def next_func() -> Optional[models.MembersListMembersResponse]:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.MembersListMembersResponse(
                result=unmarshal_json_response(models.ListResourceMember, http_res),
                next=next_func,
            )
    ...
    def create_member(
        self,
        *,
        request: Union[models.MemberCreate, models.MemberCreateTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
        ...
        **Scopes**: `members:write`
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.MemberCreate)
        request = cast(models.MemberCreate, request)
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", models.MemberCreate
            ),
            timeout_ms=timeout_ms,
        )
    ...
    def get_member(
        ...
        **Scopes**: `members:read` `members:write`
        ...
        request = models.MembersGetMemberRequest(
            id=id,
        )
    ...
    def update_member(
        ...
        **Scopes**: `members:write`
        ...
        request = models.MembersUpdateMemberRequest(
            id=id,
    ...
    def delete_member(
        ...
        **Scopes**: `members:write`
        ...
        request = models.MembersDeleteMemberRequest(
            id=id,
        )
