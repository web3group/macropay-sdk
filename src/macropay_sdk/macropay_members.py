...
class MacropayMembers(BaseSDK):
    def list_members(
        ...
        *,
    ...
    ) -> Optional[models.CustomerPortalMembersListMembersResponse]:
        r"""List Members
        ...
        request = models.CustomerPortalMembersListMembersRequest(
            page=page,
            limit=limit,
        )
        ...
        def next_func() -> Optional[models.CustomerPortalMembersListMembersResponse]:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.CustomerPortalMembersListMembersResponse(
                result=unmarshal_json_response(
                    models.ListResourceCustomerPortalMember, http_res
                ),
                next=next_func,
            )
