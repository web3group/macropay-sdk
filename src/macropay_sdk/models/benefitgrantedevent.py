...
class BenefitGrantedEventTypedDict(TypedDict):
    r"""An event created by Macropay when a benefit is granted to a customer."""
...
class BenefitGrantedEvent(BaseModel):
    r"""An event created by Macropay when a benefit is granted to a customer."""
    ...
    NAME: Annotated[
        Annotated[
            Literal["benefit.granted"],
            AfterValidator(validate_const("benefit.granted")),
        ],
