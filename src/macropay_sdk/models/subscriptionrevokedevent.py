...
class SubscriptionRevokedEventTypedDict(TypedDict):
    r"""An event created by Macropay when a subscription is revoked from a customer."""
    ...
    metadata: SubscriptionRevokedMetadataTypedDict
...
class SubscriptionRevokedEvent(BaseModel):
    r"""An event created by Macropay when a subscription is revoked from a customer."""
