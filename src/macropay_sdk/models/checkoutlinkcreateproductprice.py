...
CheckoutLinkCreateProductPriceMetadataTypedDict = TypeAliasType(
    "CheckoutLinkCreateProductPriceMetadataTypedDict", Union[str, int, float, bool]
)


CheckoutLinkCreateProductPriceMetadata = TypeAliasType(
    "CheckoutLinkCreateProductPriceMetadata", Union[str, int, float, bool]
)


class CheckoutLinkCreateProductPriceTypedDict(TypedDict):
    r"""Schema to create a new checkout link from a a single product price.

    **Deprecated**: Use `CheckoutLinkCreateProducts` instead.
    """

    product_price_id: str
    metadata: NotRequired[Dict[str, CheckoutLinkCreateProductPriceMetadataTypedDict]]
...
class CheckoutLinkCreateProductPrice(BaseModel):
    r"""Schema to create a new checkout link from a a single product price.
    ...
    **Deprecated**: Use `CheckoutLinkCreateProducts` instead.
    ...
    metadata: Optional[Dict[str, CheckoutLinkCreateProductPriceMetadata]] = None
    r"""Key-value object allowing you to store additional information.
