...
class BenefitGrantDownloadablesWebhookTypedDict(TypedDict):
    created_at: datetime
    ...
    previous_properties: NotRequired[
        Nullable[BenefitGrantDownloadablesPropertiesTypedDict]
    ]


class BenefitGrantDownloadablesWebhook(BaseModel):
    created_at: datetime
    r"""Creation timestamp of the object."""
    ...
    previous_properties: OptionalNullable[BenefitGrantDownloadablesProperties] = UNSET
