...
CheckoutLinkProductPrices = TypeAliasType(
    "CheckoutLinkProductPrices", Union[LegacyRecurringProductPrice, ProductPrice]
)
...
class CheckoutLinkProductTypedDict(TypedDict):
    ...
    prices: List[CheckoutLinkProductPricesTypedDict]
...
class CheckoutLinkProduct(BaseModel):
    ...
    prices: List[CheckoutLinkProductPrices]
    r"""List of prices for this product."""
