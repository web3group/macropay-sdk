...
class MembersListMembersRequestTypedDict(TypedDict):
    ...
    sorting: NotRequired[Nullable[List[MemberSortProperty]]]
...
class MembersListMembersRequest(BaseModel):
    ...
    sorting: Annotated[
        OptionalNullable[List[MemberSortProperty]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""Sorting criterion. Several criteria can be used simultaneously and will be applied in order. Add a minus sign `-` before the criteria name to sort by descending order."""
...
class MembersListMembersResponseTypedDict(TypedDict):
    result: ListResourceMemberTypedDict


class MembersListMembersResponse(BaseModel):
    next: Callable[[], Optional[MembersListMembersResponse]]
