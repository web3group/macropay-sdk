...
class CustomerPortalLicenseKeysListResponseTypedDict(TypedDict):
    result: ListResourceLicenseKeyReadTypedDict


class CustomerPortalLicenseKeysListResponse(BaseModel):
    next: Callable[[], Optional[CustomerPortalLicenseKeysListResponse]]
