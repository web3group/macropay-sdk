...
class SubscriptionCanceledEventTypedDict(TypedDict):
    r"""An event created by Macropay when a subscription is canceled."""
    ...
    metadata: SubscriptionCanceledMetadataTypedDict
