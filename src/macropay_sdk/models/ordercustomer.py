...
OrderCustomerTaxIDTypedDict = TypeAliasType(
    "OrderCustomerTaxIDTypedDict", Union[str, TaxIDFormat]
)


OrderCustomerTaxID = TypeAliasType("OrderCustomerTaxID", Union[str, TaxIDFormat])
...
class OrderCustomer(BaseModel):
    ...
    tax_id: Nullable[List[Nullable[OrderCustomerTaxID]]]
