...
class MeterResetEventTypedDict(TypedDict):
    r"""An event created by Macropay when a customer meter is reset."""
...
class MeterResetEvent(BaseModel):
    r"""An event created by Macropay when a customer meter is reset."""
    ...
    NAME: Annotated[
        Annotated[
            Literal["meter.reset"], AfterValidator(validate_const("meter.reset"))
        ],
