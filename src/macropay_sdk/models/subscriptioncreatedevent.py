...
class SubscriptionCreatedEventTypedDict(TypedDict):
    r"""An event created by Macropay when a subscription is created."""
    ...
    metadata: SubscriptionCreatedMetadataTypedDict
