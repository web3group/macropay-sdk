...
from .balanceordermetadata import BalanceOrderMetadata, BalanceOrderMetadataTypedDict
...
class BalanceOrderEventTypedDict(TypedDict):
    r"""An event created by Macropay when an order is paid."""
    ...
    metadata: BalanceOrderMetadataTypedDict
...
class BalanceOrderEvent(BaseModel):
    r"""An event created by Macropay when an order is paid."""
    ...
    NAME: Annotated[
        Annotated[
            Literal["balance.order"], AfterValidator(validate_const("balance.order"))
        ],
