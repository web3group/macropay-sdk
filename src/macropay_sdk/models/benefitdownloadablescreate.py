...
BenefitDownloadablesCreateMetadataTypedDict = TypeAliasType(
    "BenefitDownloadablesCreateMetadataTypedDict", Union[str, int, float, bool]
)


BenefitDownloadablesCreateMetadata = TypeAliasType(
    "BenefitDownloadablesCreateMetadata", Union[str, int, float, bool]
)
...
class BenefitDownloadablesCreateTypedDict(TypedDict):
    ...
    metadata: NotRequired[Dict[str, BenefitDownloadablesCreateMetadataTypedDict]]
...
class BenefitDownloadablesCreate(BaseModel):
    description: str
    r"""The description of the benefit. Will be displayed on products having this benefit."""

    properties: BenefitDownloadablesCreateProperties

    metadata: Optional[Dict[str, BenefitDownloadablesCreateMetadata]] = None
    r"""Key-value object allowing you to store additional information.
