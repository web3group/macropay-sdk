...
class CustomerProductTypedDict(TypedDict):
    r"""Schema of a product for customer portal."""
    ...
    prices: List[CustomerProductPricesTypedDict]
...
class CustomerProduct(BaseModel):
    ...
    prices: List[CustomerProductPrices]
    r"""List of available prices for this product."""
