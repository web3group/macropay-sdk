...
class BenefitGrantDiscordWebhookTypedDict(TypedDict):
    created_at: datetime
...
class BenefitGrantDiscordWebhook(BaseModel):
    created_at: datetime
    r"""Creation timestamp of the object."""
    ...
    previous_properties: OptionalNullable[BenefitGrantDiscordProperties] = UNSET
