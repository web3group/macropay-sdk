...
class CustomerDeletedEventTypedDict(TypedDict):
    r"""An event created by Macropay when a customer is deleted."""
    ...
    metadata: CustomerDeletedMetadataTypedDict
...
class CustomerDeletedEvent(BaseModel):
    r"""An event created by Macropay when a customer is deleted."""
