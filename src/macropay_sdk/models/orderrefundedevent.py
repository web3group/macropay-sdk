...
from .orderrefundedmetadata import OrderRefundedMetadata, OrderRefundedMetadataTypedDict
...
class OrderRefundedEventTypedDict(TypedDict):
    r"""An event created by Macropay when an order is refunded."""
    ...
    metadata: OrderRefundedMetadataTypedDict
