...
class SubscriptionUncanceledEventTypedDict(TypedDict):
    r"""An event created by Macropay when a subscription cancellation is reversed."""
    ...
    metadata: SubscriptionUncanceledMetadataTypedDict
...
class SubscriptionUncanceledEvent(BaseModel):
    r"""An event created by Macropay when a subscription cancellation is reversed."""
