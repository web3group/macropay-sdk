...
class BenefitFeatureFlagSubscriberTypedDict(TypedDict):
    id: str
    ...
    properties: BenefitFeatureFlagSubscriberPropertiesTypedDict
    r"""Properties available to subscribers for a benefit of type `feature_flag`."""
    type: Literal["feature_flag"]


class BenefitFeatureFlagSubscriber(BaseModel):
    id: str
    r"""The ID of the benefit."""
