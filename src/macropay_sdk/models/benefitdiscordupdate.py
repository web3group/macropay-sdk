...
BenefitDiscordUpdateMetadataTypedDict = TypeAliasType(
    "BenefitDiscordUpdateMetadataTypedDict", Union[str, int, float, bool]
)


BenefitDiscordUpdateMetadata = TypeAliasType(
    "BenefitDiscordUpdateMetadata", Union[str, int, float, bool]
)


class BenefitDiscordUpdateTypedDict(TypedDict):
    metadata: NotRequired[Dict[str, BenefitDiscordUpdateMetadataTypedDict]]
...
class BenefitDiscordUpdate(BaseModel):
    metadata: Optional[Dict[str, BenefitDiscordUpdateMetadata]] = None
    r"""Key-value object allowing you to store additional information.
