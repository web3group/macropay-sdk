...
CustomersExportResponseTypedDict = TypeAliasType(
    "CustomersExportResponseTypedDict", Union[Any, str]
)


CustomersExportResponse = TypeAliasType("CustomersExportResponse", Union[Any, str])
