...
class SubscriptionBillingPeriodUpdatedEventTypedDict(TypedDict):
    r"""An event created by Macropay when a subscription billing period is updated."""
    ...
    r"""ID of the customer in your Macropay organization associated with the event."""
    ...
    metadata: SubscriptionBillingPeriodUpdatedMetadataTypedDict
    ...
    r"""The source of the event. `system` events are created by Macropay. `user` events are the one you create through our ingestion API."""
    name: Literal["subscription.billing_period_updated"]
    r"""The name of the event."""


class SubscriptionBillingPeriodUpdatedEvent(BaseModel):
    r"""An event created by Macropay when a subscription billing period is updated."""
    ...
    NAME: Annotated[
        Annotated[
            Literal["subscription.billing_period_updated"],
            AfterValidator(validate_const("subscription.billing_period_updated")),
        ],
