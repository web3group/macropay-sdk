...
class BalanceDisputeReversalEventTypedDict(TypedDict):
    r"""An event created by Macropay when a dispute is won and funds are reinstated."""
    ...
    metadata: BalanceDisputeMetadataTypedDict
...
class BalanceDisputeReversalEvent(BaseModel):
    r"""An event created by Macropay when a dispute is won and funds are reinstated."""
    ...
    NAME: Annotated[
        Annotated[
            Literal["balance.dispute_reversal"],
            AfterValidator(validate_const("balance.dispute_reversal")),
        ],
