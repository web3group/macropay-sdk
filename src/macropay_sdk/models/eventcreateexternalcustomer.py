...
class EventCreateExternalCustomerTypedDict(TypedDict):
    ...
    r"""The ID of the parent event. Can be either a Macropay event ID (UUID) or an external event ID."""
    metadata: NotRequired[Dict[str, EventMetadataInputTypedDict]]
    external_member_id: NotRequired[Nullable[str]]
    r"""ID of the member in your system within the customer's organization who performed the action. Used for member-level attribution in B2B."""
