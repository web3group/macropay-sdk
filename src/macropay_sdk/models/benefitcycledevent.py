...
class BenefitCycledEventTypedDict(TypedDict):
    r"""An event created by Macropay when a benefit is cycled."""
...
class BenefitCycledEvent(BaseModel):
    r"""An event created by Macropay when a benefit is cycled."""
    ...
    NAME: Annotated[
        Annotated[
            Literal["benefit.cycled"], AfterValidator(validate_const("benefit.cycled"))
        ],
