...
class BalanceDisputeEventTypedDict(TypedDict):
    r"""An event created by Macropay when an order is disputed."""
...
class BalanceDisputeEvent(BaseModel):
    r"""An event created by Macropay when an order is disputed."""
    ...
    NAME: Annotated[
        Annotated[
            Literal["balance.dispute"],
            AfterValidator(validate_const("balance.dispute")),
        ],
