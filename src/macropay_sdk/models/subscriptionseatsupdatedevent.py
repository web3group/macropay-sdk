...
class SubscriptionSeatsUpdatedEventTypedDict(TypedDict):
    r"""An event created by Macropay when a the seats on a subscription is changed."""
    ...
    metadata: SubscriptionSeatsUpdatedMetadataTypedDict
...
class SubscriptionSeatsUpdatedEvent(BaseModel):
    r"""An event created by Macropay when a the seats on a subscription is changed."""
    ...
    NAME: Annotated[
        Annotated[
            Literal["subscription.seats_updated"],
            AfterValidator(validate_const("subscription.seats_updated")),
        ],
