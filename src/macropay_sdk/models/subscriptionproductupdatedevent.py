...
class SubscriptionProductUpdatedEventTypedDict(TypedDict):
    r"""An event created by Macropay when a subscription changes the product."""
...
class SubscriptionProductUpdatedEvent(BaseModel):
    r"""An event created by Macropay when a subscription changes the product."""
    ...
    NAME: Annotated[
        Annotated[
            Literal["subscription.product_updated"],
            AfterValidator(validate_const("subscription.product_updated")),
        ],
