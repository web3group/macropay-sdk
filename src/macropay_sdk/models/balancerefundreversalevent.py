...
class BalanceRefundReversalEventTypedDict(TypedDict):
    r"""An event created by Macropay when a refund is reverted."""
...
class BalanceRefundReversalEvent(BaseModel):
    r"""An event created by Macropay when a refund is reverted."""
    ...
    NAME: Annotated[
        Annotated[
            Literal["balance.refund_reversal"],
            AfterValidator(validate_const("balance.refund_reversal")),
        ],
