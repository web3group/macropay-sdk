...
class BenefitRevokedEventTypedDict(TypedDict):
    r"""An event created by Macropay when a benefit is revoked from a customer."""
...
class BenefitRevokedEvent(BaseModel):
    r"""An event created by Macropay when a benefit is revoked from a customer."""
    ...
    NAME: Annotated[
        Annotated[
            Literal["benefit.revoked"],
            AfterValidator(validate_const("benefit.revoked")),
        ],
