...
class BalanceCreditOrderEventTypedDict(TypedDict):
    r"""An event created by Macropay when an order is paid via customer balance."""
    ...
    metadata: BalanceCreditOrderMetadataTypedDict
...
class BalanceCreditOrderEvent(BaseModel):
    r"""An event created by Macropay when an order is paid via customer balance."""
    ...
    NAME: Annotated[
        Annotated[
            Literal["balance.credit_order"],
            AfterValidator(validate_const("balance.credit_order")),
        ],
