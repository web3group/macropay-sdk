...
BenefitMeterCreditUpdateMetadataTypedDict = TypeAliasType(
    "BenefitMeterCreditUpdateMetadataTypedDict", Union[str, int, float, bool]
)


BenefitMeterCreditUpdateMetadata = TypeAliasType(
    "BenefitMeterCreditUpdateMetadata", Union[str, int, float, bool]
)


class BenefitMeterCreditUpdateTypedDict(TypedDict):
    metadata: NotRequired[Dict[str, BenefitMeterCreditUpdateMetadataTypedDict]]
...
class BenefitMeterCreditUpdate(BaseModel):
    metadata: Optional[Dict[str, BenefitMeterCreditUpdateMetadata]] = None
    r"""Key-value object allowing you to store additional information.
