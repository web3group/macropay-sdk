...
CustomFieldUpdateCheckboxMetadataTypedDict = TypeAliasType(
    "CustomFieldUpdateCheckboxMetadataTypedDict", Union[str, int, float, bool]
)


CustomFieldUpdateCheckboxMetadata = TypeAliasType(
    "CustomFieldUpdateCheckboxMetadata", Union[str, int, float, bool]
)
...
class CustomFieldUpdateCheckboxTypedDict(TypedDict):
    ...
    metadata: NotRequired[Dict[str, CustomFieldUpdateCheckboxMetadataTypedDict]]
...
class CustomFieldUpdateCheckbox(BaseModel):
    ...
    metadata: Optional[Dict[str, CustomFieldUpdateCheckboxMetadata]] = None
    r"""Key-value object allowing you to store additional information.
