...
class MeterCreditEventTypedDict(TypedDict):
    r"""An event created by Macropay when credits are added to a customer meter."""
    ...
    metadata: MeterCreditedMetadataTypedDict
...
class MeterCreditEvent(BaseModel):
    r"""An event created by Macropay when credits are added to a customer meter."""
    ...
    NAME: Annotated[
        Annotated[
            Literal["meter.credited"], AfterValidator(validate_const("meter.credited"))
        ],
