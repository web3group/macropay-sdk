...
class BenefitGrantFeatureFlagWebhookTypedDict(TypedDict):
    created_at: datetime
    ...
    """
    properties: BenefitGrantFeatureFlagPropertiesTypedDict
    ...
    previous_properties: NotRequired[
        Nullable[BenefitGrantFeatureFlagPropertiesTypedDict]
    ]


class BenefitGrantFeatureFlagWebhook(BaseModel):
    created_at: datetime
    r"""Creation timestamp of the object."""
    ...
    previous_properties: OptionalNullable[BenefitGrantFeatureFlagProperties] = UNSET
