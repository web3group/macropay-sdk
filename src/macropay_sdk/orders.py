...
class Orders(BaseSDK):
        ...
        **Scopes**: `orders:read`
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.OrdersListResponse(
                result=unmarshal_json_response(models.ListResourceOrder, http_res),
                next=next_func,
            )
    ...
    def export(
        ...
        *,
        organization_id: OptionalNullable[
            Union[
                models.OrdersExportQueryParamOrganizationIDFilter,
                models.OrdersExportQueryParamOrganizationIDFilterTypedDict,
            ]
        ] = UNSET,
        product_id: OptionalNullable[
            Union[
                models.OrdersExportQueryParamProductIDFilter,
                models.OrdersExportQueryParamProductIDFilterTypedDict,
            ]
        ] = UNSET,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        **Scopes**: `orders:read`
        ...
        request = models.OrdersExportRequest(
            organization_id=organization_id,
            product_id=product_id,
        )
    ...
    def update(
        ...
        **Scopes**: `orders:write`
        ...
        request = models.OrdersUpdateRequest(
            id=id,
    ...
    def generate_invoice(
        ...
        **Scopes**: `orders:read`
        ...
        request = models.OrdersGenerateInvoiceRequest(
            id=id,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="orders:generate_invoice",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        if utils.match_response(http_res, "422", "application/json"):
            response_data = unmarshal_json_response(
                models.OrdersGenerateInvoiceResponse422OrdersGenerateInvoiceUnion,
                http_res,
            )
            raise models.OrdersGenerateInvoiceResponse422OrdersGenerateInvoice(
    ...
    def invoice(
        ...
        **Scopes**: `orders:read`
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.OrderInvoice, http_res)
        if utils.match_response(http_res, "404", "application/json"):
            response_data = unmarshal_json_response(
                models.ResourceNotFoundData, http_res
            )
